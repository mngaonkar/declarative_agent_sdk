"""
Agent Registry - Registry pattern for managing BaseAgent instances.
...
class AgentRegistry:
    """
    Registry to track and manage BaseAgent instances.
    ...
    def register(
        ...
        **metadata
        ...
        Args:
            agent: BaseAgent instance to register (must have 'name' attribute)
